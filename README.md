...
- Tabela completa com busca, ordenação por coluna e paginação
...
- Botões de acesso rápido no topo da tela para **Importar Base** e
  **Apagar Base** (limpa todos os registros; pede confirmação antes de
  executar)
...
Projeto criado por **Daniel Talison** — contato: (32) 9 8888-3345
